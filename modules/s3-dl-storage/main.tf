...
module "s3_main" {
  # https://github.com/terraform-aws-modules/terraform-aws-s3-bucket#input_server_side_encryption_configuration
  ...
  # We are desabling policies on first version of MVP Data Lake.
  attach_policy = false
